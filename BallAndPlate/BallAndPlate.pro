...
BallAndPlateRootPath=/home/hasan/workspace/CSE395_Proje1_Group6/BallAndPlate

gameProjectFile=/home/hasan/workspace/CSE395_Proje1_Group6/BallAndPlate/BallAndPlate.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(BallAndPlateSource.pri)
include(BallAndPlateHeader.pri)
include(BallAndPlateConfig.pri)
include(BallAndPlateIncludes.pri)
include(BallAndPlateDefines.pri)
...
BallAndPlate-Linux-Debug.commands = $$build BallAndPlate Linux Debug  -project="\"$$gameProjectFile\"" $$args
BallAndPlate-Linux-DebugGame.commands = $$build BallAndPlate Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BallAndPlate-Linux-Shipping.commands = $$build BallAndPlate Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BallAndPlate-Linux-Test.commands = $$build BallAndPlate Linux Test  -project="\"$$gameProjectFile\"" $$args
BallAndPlate.commands = $$build BallAndPlate Linux Development  -project="\"$$gameProjectFile\"" $$args

BallAndPlateEditor-Linux-Debug.commands = $$build BallAndPlateEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BallAndPlateEditor-Linux-DebugGame.commands = $$build BallAndPlateEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BallAndPlateEditor-Linux-Shipping.commands = $$build BallAndPlateEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BallAndPlateEditor-Linux-Test.commands = $$build BallAndPlateEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BallAndPlateEditor.commands = $$build BallAndPlateEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	BallAndPlate-Linux-Debug \
	BallAndPlate-Linux-DebugGame \
	BallAndPlate-Linux-Shipping \
	BallAndPlate-Linux-Test \
	BallAndPlate \
	BallAndPlateEditor-Linux-Debug \
	BallAndPlateEditor-Linux-DebugGame \
	BallAndPlateEditor-Linux-Shipping \
	BallAndPlateEditor-Linux-Test \
	BallAndPlateEditor \
